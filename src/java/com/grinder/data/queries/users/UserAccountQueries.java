...
public class UserAccountQueries {
    ...
    public static final String SELECT_BY_ACCOUNT_NAME_AND_PASSWORD = "SELECT * FROM accounts WHERE account_name = ? AND password = MD5(?)";
    public static final String UPDATE_ACCOUNT = "UPDATE accounts SET account_name = ?, password = MD5(?), status_id = ?, modified_date= ? WHERE account_id = ?";
    public static final String INSERT_ACCOUNT = "INSERT INTO accounts (account_name, password, status_id) VALUES (?,MD5(?),?)";
